...
input
 4 num
output
count num that can be modulus by d == r within range of a and b
constraint
must be num within a and b
```
...
```text
s1 receive 4 input
s2 start loop within a to b and 
if mod by d == r then count +=1
print count
```
