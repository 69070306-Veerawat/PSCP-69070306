...
```text
input สองสี
output ผลลัพของสองสี
constraint อาจเป็นสีเดียวกันได้
...
```text
s1 receive input
s2 check what is the result of two color combined
s3 print the result color
```
...
```text
result is not as plan because i did not expect input  can be same color(red-red)
```
