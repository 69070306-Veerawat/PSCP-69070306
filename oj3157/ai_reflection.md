...
| Item | Answer |
|---|---|
| OJ problem number/title | OJ3157 - [LEARNING LOGS] เกมสะสมแต้ม |
...
```text
use ai to find out what i did wrong
ans: i tried to use itertool.cycle to solve the problem but ai teach me that it can be solve by using basic equation
```
...
```text
rewrite code by using the correct equation
```
...
```text
i should change my approch and stop overthinking and start thinking methemeticly more
```
