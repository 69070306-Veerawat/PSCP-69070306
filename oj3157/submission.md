...
```text
input: num of command and all command
output: total score
constaint:increase by 10 and decrease by 5
```
...
```text
s1 receive num of command
s2 receive each command and  increase or decrease score as require
s3 print total score
```
...
```text
same as original nothing complicate
```
