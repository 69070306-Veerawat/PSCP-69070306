...
receive 2 num
output
the calculated season from input
constraint
none
```
...
```text
s1 receive two input
s2 write if else for all season
s3 print result
```
...
```text
check before changing of season
```
