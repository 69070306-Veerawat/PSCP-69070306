...
```text
input: prize lottery, bought lottery
output:  prize money gain
constraint: many condition for prize money
```
...
```text
s1 receive input
s2 check condition and calculate prize money
s3 print prize money
```
