...
| I used AI as a coach, reviewer, debugger, or test-case helper, not as a full-answer generator. | No |  |

ถ้าตอบ "No" ในข้อใด ให้อธิบายเหตุผล:

```text
ไม่ทราบว่าต้องอ่านที่ไหน
ใช้codeหาสมการ
```
...
```text
ได้เรียนรู้ว่าสมการที่ต้องใช้มีหลักการความคิดยังไง
```
