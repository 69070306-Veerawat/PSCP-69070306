...
```text
input: speed of ink, number of people
coordinate of people
output:
time that ink will reach them
contraints:
if output == float
make it integer
```
...
```text
step1:receive input of speed and num of people
step2: receive input of coordinate of people
step3: calculate the time and print the answer
```
...
```text
same plan as original but need more time to find equation then expect
```
