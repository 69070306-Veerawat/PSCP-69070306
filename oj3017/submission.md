...
```text
s1 - receive input
s2 calculate to see if service fee is greater then 50 or not
s3 if lesser then 50 then change service fee to 50
s4 if greater then 1000 change service fee to 1000
s5 then proceed to calculate VAT
s6 print result of (original fee + service fee + VAT)
```
...
```text
check result of service fee < 50
```
