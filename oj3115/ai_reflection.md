...
```text
วิธีคิดเเบบใหม่ โดยการสร้างlist ของนาที่ทั้งวัน
```
...
```text
ได้ideaเเล้วลองพยายามเขียนเองดู
```
...
```text
ได้เรียนรู้เกี่ยวกับเเนวคิดที่ไม่เคยเห็นมาก่อน เช่น การใช้ list ในปริมานมหาสาล
```
