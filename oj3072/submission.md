...
```text
s1 receive input
s2 check if i in word is a e i o u 
if == a e i o u increase count
s3 print a e i o u include count if > 0
```
...
```text
plan remain same nothing change
```
...
```text
check what happen if no a e i o u
```
